...
namespace WCF_ENAP
{
    public class Global : HttpApplication
    {
        ...
        {
            RouteTable.Routes.Add(new ServiceRoute("TemplatePrograma", new WebServiceHostFactory(), typeof(TemplatePrograma)));
            RouteTable.Routes.Add(new ServiceRoute("GraphEventosOrganizacion", new WebServiceHostFactory(), typeof(GraphEventosOrganizacion)));
