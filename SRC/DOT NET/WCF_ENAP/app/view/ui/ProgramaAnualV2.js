...
Ext.define('WCF_ENAP.view.ui.ProgramaAnualV2', {
    ...
    initComponent: function () {
        ...
        dsGraphAvanceProgramaAnual.on('load', function (store, records, successful, operation, eOpts) {
            ...
            Ext.getCmp('graphAvanceProgramaAnual').redraw();
        });
        ...
        var fnListenerProgramaAnual = function (store, records, index, eOpts) {
            var selectedYear = me.contextMenuFilters.getComponent(0).getValue(),
				storeGraph = Ext.StoreManager.lookup('dsGraphAvanceProgramaAnual');
            storeGraph.pageSize = (dsProgramaAnual.pageSize);
            storeGraph.currentPage = (dsProgramaAnual.currentPage);
            storeGraph.load();
            ...
            items: [
		        {
		            ...
		            listeners: {
		                change: function (field, newValue, oldValue, eOpts) {
                            ...
                            storeGraph.setProxy(Ext.apply(storeGraph.getProxy(), {
                                extraParams: {
                                    ...
                                    listeners: {
                                        change: function (paging, pageData, eOpts) {
                                            if (!Ext.isEmpty(pageData.currentPage) && !Ext.isEmpty(pageData.total) && Ext.isNumber(pageData.currentPage)) {
                                                //var storeGraph = Ext.StoreManager.lookup('dsGraphAvanceProgramaAnual');
                                                //storeGraph.currentPage = pageData.currentPage;
                                            }
                                        }
                                    }
                                },
