															    ...
															    buttons: [{
															        ...
															        handler: function () {
															            var new_object,
																			...
																			form,
                                                                            values;
															            values = Ext.getCmp('form_datos_trabajador').getForm().getValues();

															            var formValues = Ext.apply({
															                'TIPO_INCIDENTE_PERSONA_LIST': Ext.getCmp('TIPO_INCIDENTE_PERSONA').getRawValue(),
															                'CAUSA_INMEDIATA_ACCION_LIST': Ext.getCmp('CAUSA_INMEDIATA_ACCION').getRawValue()
															            }, values);
