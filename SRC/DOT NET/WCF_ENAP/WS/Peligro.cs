...
namespace WCF_ENAP
{
	...
	public class Peligro
	{
        ...
        public JSONCollection<List<TBL_PELIGRO>> GetCollection(int _page,int _start, int _limit,string _sort, string _dir)
        {
        ...
        public JSONCollection<TBL_PELIGRO> Create(string NOM_PELIGRO)
		{
