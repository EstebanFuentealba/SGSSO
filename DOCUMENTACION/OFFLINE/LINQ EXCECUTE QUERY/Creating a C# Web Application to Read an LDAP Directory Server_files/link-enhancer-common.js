(function(){
{
    ...
    var redirect = new RegExp("^http://www\\.amazon\\.(com|ca|co\\.jp|de|fr|co\\.uk|cn)/(exec/obidos|o)/redirect", "i");
    var asin     = new RegExp("^http://www\\.amazon\\.(com|ca|co\\.jp|de|fr|co\\.uk|cn)/(exec/obidos|o)/ASIN\\d?/\\w{10}/(ref=[\\w]+/)?([^/?]+)", "i");
    var product  = new RegExp("^http://www\\.amazon\\.(com|ca|co\\.jp|de|fr|co\\.uk|cn)/(gp/(product|offer-listing)|([^/]+/)?dp)/\\w{10}(/ref=[\\w]+)?/?\\?([^/?]+)", "i");
    var isbn     = new RegExp("^http://www\\.amazon\\.(com|ca|co\\.jp|de|fr|co\\.uk|cn)/(exec/obidos|o)/ISBN=\\w{10}/(ref=[\\w]+/)?([^/?]+)A", "i");
    var mp       = new RegExp("^http://www\\.amazon\\.(com|ca|co\\.jp|de|fr|co\\.uk|cn)/gp/associates/link-types/marketplace", "i");
    var mn        = new RegExp("^http://[\\w\\-\\.]+\\.amazon\\.(com|ca|co\\.jp|de|fr|co\\.uk|cn)/mn/detailApp", "i");
